function download_test
    ...
    printf "\033[1;36m[STORAGE]\033[0m Initializing Hormuud 100Gbps Fiber Environment...\n\n"
    ...
    printf "Resource:  %s\n" $random_res
    printf "Node:      %s\n" $random_node
    printf "Status:    [\033[1;32m 100GBPS LINK ACTIVE \033[0m]\n"
    ...
    set random_mbps 98500  # Initial 100Gbps base
    set random_ms 1
    ...
    while test $current_mb -lt $total_mb
        if test $tick_counter -ge $next_shift_ticks
            ...
            if test (random 1 50) -eq 1
                ...
                set random_mbps (random 96000 104000) # 100Gbps range
