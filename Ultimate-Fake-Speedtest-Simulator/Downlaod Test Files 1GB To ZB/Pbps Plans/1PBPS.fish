function download_test
    ...
    printf "\033[1;36m[STORAGE]\033[0m Initializing Hormuud 1Pbps Teracore Array...\n\n"
    ...
    printf "Resource:  %s\n" $random_res
    printf "Node:      %s\n" $random_node
    printf "Status:    [\033[1;32m 1PBPS TERA-LINK ACTIVE \033[0m]\n"
    ...
    set random_mbps 985000000  # 1Pbps base in Mbps
    set random_ms 0
    ...
    while test $current_mb -lt $total_mb
        if test $tick_counter -ge $next_shift_ticks
            ...
            # Fluctuation around 1,000,000,000 Mbps
            set random_mbps (random 980000000 1050000000) 
            set random_ms 0
        end
