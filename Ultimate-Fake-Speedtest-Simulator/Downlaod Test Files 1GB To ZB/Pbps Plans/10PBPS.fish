function download_test
    ...
    printf "\033[1;36m[STORAGE]\033[0m Initializing Hormuud 10Pbps Planetary-Grid Array...\n\n"
    ...
    printf "Resource:  %s\n" $random_res
    printf "Node:      %s\n" $random_node
    printf "Status:    [\033[1;32m 10PBPS PLANETARY LINK ACTIVE \033[0m]\n"
    ...
    set random_mbps 10000000000  # 10Pbps = 10 Billion Mbps
    set random_ms 0
    ...
    while test $current_mb -lt $total_mb
        if test $tick_counter -ge $next_shift_ticks
            ...
            # Throughput around 10 Billion Mbps
            set random_mbps (random 9800000000 10200000000) 
            set random_ms 0
        end
