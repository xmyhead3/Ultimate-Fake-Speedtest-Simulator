function download_test
    ...
    printf "\033[1;36m[STORAGE]\033[0m Initializing Hormuud 500Tbps Hyper-Core Environment...\n\n"
    ...
    printf "Resource:  %s\n" $random_res
    printf "Node:      %s\n" $random_node
    printf "Status:    [\033[1;32m 500TBPS HYPER-LINK ACTIVE \033[0m]\n"
    ...
    set random_mbps 485000000  # Initial 500Tbps base in Mbps
    set random_ms 0
    ...
    while test $current_mb -lt $total_mb
        if test $tick_counter -ge $next_shift_ticks
            ...
            # Massive throughput fluctuation around 500Tbps
            set random_mbps (random 475000000 525000000) 
            set random_ms 0
        end

        # Speed divided by 8 (bits to bytes) divided by 10 (0.1s sleep)
